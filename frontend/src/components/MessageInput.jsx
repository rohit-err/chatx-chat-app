    ...
    <div className="p-2 sm:p-4 w-full max-w-full">
      {imagePreview && (
        <div className="mb-2 sm:mb-3 flex items-center gap-2">
          <div className="relative">
            ...
            <button
              onClick={removeImage}
              className="absolute -top-1 -right-1 sm:-top-1.5 sm:-right-1.5 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-base-300
      ...
      <form onSubmit={handleSendMessage} className="flex items-center gap-1 sm:gap-2">
        <div className="flex-1 flex gap-1 sm:gap-2 min-w-0">
          <input
            type="text"
            className="w-full min-w-0 input input-bordered rounded-lg input-sm sm:input-md
